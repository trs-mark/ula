 ...
 */
exports.NavigationWindowController = function() {
	this.windowStack = [];
};
 ...
 */
exports.NavigationWindowController.prototype.open = function(windowToOpen, args) {
	...
	if(this.windowStack.length === 1) {
		...
		if(ULA_IS_ANDROID) {
			...
			this.navGroup.openWindow(windowToOpen, args);
		}
	}
};
 ...
 * @param {Object} window
 */
exports.NavigationWindowController.prototype.home = function(homeWindow) {
 ...
 * 
 */
exports.NavigationWindowController.prototype.back = function(limit, windowToBack) {
	...
	for(var i = 1, l = limit; i < l; i++) {
		...
		(this.navGroup) ? this.navGroup.closeWindow(windows[len], {animated:false}) : windows[len].close();
	...
	(this.navGroup) ? this.navGroup.closeWindow(newWindows[base]) : newWindows[base].close();
